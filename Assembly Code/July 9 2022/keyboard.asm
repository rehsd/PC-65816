...
key_pressed:
    ...
    //workaround - keyboard shift register seems to retain last key, even when power is removed. ???
    lda kb_enable
    cmp #0
    beq enable_keyboard
    ...
    //lda $100002
    jsr sound_raise_interrupt_on_card

    pha   //bandaid -- need to adjust print_char_vga to restore registers as needed
    jsr print_char_vga
    pla
